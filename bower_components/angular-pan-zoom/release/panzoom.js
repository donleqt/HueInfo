            ...
            return {
                ...
                controller: ['$scope', '$element', '$timeout',
                    function ($scope, $element, $timeout) {
                        ...
                        //    var W = $scope.config.width;
                        //    var H = $scope.config.width;
                        //
                        //
                        //    var w = rect.width;
                        //    var h = rect.height;
                        ...
                        var syncModelToDOM = function () {
                            ...
                            if($scope.config.imgheight* $scope.scale> $scope.config.height){
                                ...
                                //if ($scope.model.pan.y <  $scope.config.deltaTop  ){
                                    $scope.model.pan.y = ($scope.config.height - $scope.config.imgheight*$scope.scale)/2
                                //}
                                //else if ($scope.model.pan.y >  $scope.config.deltaTop || $scope.scale == 1){
                                //    $scope.model.pan.y =  $scope.config.deltaTop;
                                //}
                            }
                            //
                            //
                            ...
                            //    $scope.model.pan.y = 0;
                            //} else if ($scope.model.pan.y < 0){
                            //    if($scope.model.pan.y + $scope.config.height*$scope.scale < $scope.config.height){
                            //        $scope.model.pan.y = $scope.config.height -  $scope.config.height*$scope.scale;
                            //        $scope.base.pan.y = $scope.model.pan.y;
                            //
                            //    }
                            //}
